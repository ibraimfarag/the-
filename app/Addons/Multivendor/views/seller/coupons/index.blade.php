...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
            <a href="{{ route('seller.coupons.create') }}" class="btn btn-circle btn-info">
            ...
            <tbody>
                @foreach($coupons as $key => $coupon)
                    <tr>
						...
						<td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('seller.coupons.edit', encrypt($coupon->id) )}}" title="{{ translate('Edit') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('seller.coupons.destroy', $coupon->id)}}" title="{{ translate('Delete') }}">
