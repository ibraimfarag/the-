...
class CouponController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('addon:multivendor::seller.coupons.index', compact('coupons'));
    }
    ...
    {
        return view('addon:multivendor::seller.coupons.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('addon:multivendor::seller.coupons.edit', compact('coupon'));
    }
    ...
    {
        if ($request->coupon_type == "product_base") {
            return view('addon:multivendor::seller.coupons.product_base_coupon');
        } elseif ($request->coupon_type == "cart_base") {
            return view('addon:multivendor::seller.coupons.cart_base_coupon');
        }
    }
    ...
    public function get_coupon_form_edit(Request $request)
    {
        if ($request->coupon_type == "product_base") {
            ...
            return view('addon:multivendor::seller.coupons.product_base_coupon_edit', compact('coupon'));
        } elseif ($request->coupon_type == "cart_base") {
            $coupon = Coupon::findOrFail($request->id);
            return view('addon:multivendor::seller.coupons.cart_base_coupon_edit', compact('coupon'));
        }
    }
}
