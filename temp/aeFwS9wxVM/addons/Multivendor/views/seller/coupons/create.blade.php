...
@section('content')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal" action="{{ route('seller.coupons.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<script type="text/javascript">
    ...
    function coupon_form(){
		...
		$.post('{{ route('seller.coupons.get_coupon_form') }}',{_token:'{{ csrf_token() }}', coupon_type:coupon_type}, function(data){
