                        ...
                        @if ($product->discount > 0)
                            <div class="border border-dotted rounded py-2 px-3 mr-3 ml-0 bg-danger text-white">
                                ...
                                <div class="opacity-60 fs-12">
                                    {{ \Carbon\Carbon::createFromTimestamp($product->discount_start_date)->toDateTimeString() }} -
                                    {{ \Carbon\Carbon::createFromTimestamp($product->discount_end_date)->toDateTimeString() }}</div>
                            </div>
                        @endif
                    </div>
                </div>
