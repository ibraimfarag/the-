...
@section('content')
    ...
    <form class="form form-horizontal mar-top" action="{{route('seller.product.store')}}" method="POST" enctype="multipart/form-data" id="product_form">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="no_product_variant">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" min="0" value="1" placeholder="{{ translate('Price') }}" name="price" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('SKU')}}</label>
                                <div class="col-md-8">
                                    <input type="test" placeholder="{{ translate('SKU') }}" name="sku" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="standard_delivery_time" value="24" min="0" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="express_delivery_time" value="24" min="0" required>
                                    <div class="input-group-append"><span class="input-group-text">hr(s)</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" value="0" class="form-control" name="weight" min="0" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" value="0" class="form-control" name="height" min="0" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" value="0" class="form-control" name="length" min="0" required>
                                    <div class="input-group-append"><span class="input-group-text">{{ get_setting('dimension_unit') }}</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" value="0" class="form-control" name="width" min="0" required>
                                    <div class="input-group-append"><span class="input-group-text">{{ get_setting('dimension_unit') }}</span></div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @if(count($category->childrenCategories) > 0)
                                            <ul class="list-unstyled ml-3">
                                                @foreach ($category->childrenCategories as $childCategory)
                                                    <li>
                                                        <label class="aiz-checkbox">
                                                            <input type="checkbox" value="{{$childCategory->id}}" name="category_ids[]">
                                                            <span class="aiz-square-check"></span>
                        ...
                        @foreach(\App\Models\Tax::all() as $tax)
                            ...
                            <div class="form-row">
                                <div class="form-group col-6">
                                    <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Tax') }}" name="taxes[]" class="form-control" required>
                                </div>
                                <div class="form-group col-6">
